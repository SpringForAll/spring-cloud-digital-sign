package com.spring4all.digitalsign.engine.self.cert.core.license;

import cn.topca.api.cert.CertApiException;
import cn.topca.api.cert.TCA;
import com.spring4all.digitalsign.engine.self.cert.core.license.require.LicenseAbstract;
